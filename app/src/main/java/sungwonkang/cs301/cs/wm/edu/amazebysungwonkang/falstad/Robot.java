...
public interface Robot {
	...
	/**
	 * Returns pathlength that is counted int he move() method.
	 * @return pathlength
	 */
	...
	/**
	 * Tells if there is a wall at a certain direction of a certain coordinate. 
	 * @param a coordinate (x and y) and a direction
	 * @return true if there is a wall, false otherwise
	 */
	boolean wallExists(int x, int y, CardinalDirection dir);
}