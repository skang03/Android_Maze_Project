...
import sungwonkang.cs301.cs.wm.edu.amazebysungwonkang.falstad.MazeFileWriter;
...
public class Seg {
	...
	private int color; 	// color of segment, only set by constructor and file reader
	...
	private void initColor(int distance, int cc) {
		...
		switch (part2) {
		case 0: setColor(Color.argb(255, 102, 0, 0)); break;
		case 1: setColor(Color.argb(255, 199, 135, 8)); break;
		case 2: setColor(Color.argb(255, 182, 177, 131)); break;
		case 3: setColor(Color.argb(255, 105, 144, 66)); break;
		case 4: setColor(Color.argb(255, 102, 204, 204)); break;
		case 5: setColor(Color.argb(255, 6, 27, 111)); break;
		default: setColor(Color.argb(255, 51, 0, 102)); break;
		}
	}
	...
	public boolean equals(Object other){
		...
		if ((x != o.x) || (dx != o.dx) ||(y != o.y) || (dy != o.dy)) 
			return false ; 
		if ((dist != o.dist) || (partition != o.partition) ||(seen != o.seen) || (color != o.color))
			return false ;
